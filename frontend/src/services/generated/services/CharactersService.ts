...
import type { ApiResponse_Page_CharacterRead__ } from '../models/ApiResponse_Page_CharacterRead__';
...
export class CharactersService {
     ...
     * 列出characters
     * 分頁列出資產。
     * @returns ApiResponse_Page_CharacterRead__ Successful Response
     * @throws ApiError
     */
    public static listCharacters({
         ...
         */
        pageSize?: number,
    }): CancelablePromise<ApiResponse_Page_CharacterRead__> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/studio/projects/{project_id}/characters',
            path: {
    ...
    public static getCharacter({
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/studio/characters/{asset_id}',
            path: {
                'asset_id': assetId,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static checkCharacterExists({
        name,
        projectId,
    }: {
        /**
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/studio/characters/exists/check',
            query: {
                'name': name,
                'project_id': projectId,
            },
     ...
     * @throws ApiError
     */
    public static listCharacterImages({
        assetId,
    }: {
        assetId: string,
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/studio/characters/{asset_id}/images',
            path: {
                'asset_id': assetId,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static addCharacterImage({
        assetId,
        requestBody,
    }: {
        assetId: string,
     ...
     * @throws ApiError
     */
    public static deleteCharacterImage({
        imageId,
    }: {
        imageId: string,
    }): CancelablePromise<ApiResponse_OkData_> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/v1/studio/characters/images/{image_id}',
            path: {
                'image_id': imageId,
            },
            errors: {
